...
def service_add_form():
    return btforms.Form(
        ...
        btforms.Hidden("normal_check_interval", rules.is_number, description=u"检测间隔时间（分）",required="required",**input_style),
        btforms.Hidden("retry_check_interval", rules.is_number, description=u"重试间隔时间（分）",required="required",**input_style),
