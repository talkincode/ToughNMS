...
def service_add_form():
    return pyforms.Form(
        ...
        pyforms.Textbox("max_check_attempts", rules.is_number, description=u"最大重试次数",required="required",**input_style),
        pyforms.Hidden("normal_check_interval", rules.is_number, description=u"检测间隔时间（分）",required="required",**input_style),
        pyforms.Hidden("retry_check_interval", rules.is_number, description=u"重试间隔时间（分）",required="required",**input_style),
