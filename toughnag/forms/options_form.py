...
option_update_form = pyforms.Form(
    ...
    pyforms.Textbox("nagios_bin", rules.len_of(1, 128), description=u"Nagios执行文件", required="required", **input_style),
    pyforms.Textbox("nagios_service", rules.len_of(1, 128), description=u"Nagios服务名", required="required", **input_style),
    pyforms.Textbox("nagios_cfg", rules.len_of(1, 128), description=u"Nagios配置文件", required="required", **input_style),
    pyforms.Textbox("nagios_host_group_cfg", rules.len_of(1, 128), description=u"Nagios主机组配置文件", required="required", **input_style),
    pyforms.Textbox("nagios_host_cfg_dir", rules.len_of(1, 128), description=u"Nagios主机配置目录", required="required", **input_style),    
