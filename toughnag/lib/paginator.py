...
class Paginator():
    ...
    def render(self):
        ...
        if current_start == 1:
            ...
            _htmls.append('\t<li><a href="%s">首页</a></li>' % self.url_func(1))
            _htmls.append('\t<li><a href="%s">&larr; 上一页</a></li>' % self.url_func(current_start - 1))
        ...
        if current_end == self.page_num:
            ...
            _htmls.append('\t<li><a href="%s">下一页 &rarr;</a></li>' % self.url_func(current_end + 1))
            _htmls.append('\t<li><a href="%s">尾页</a></li>' % self.url_func(self.page_num))
